...
En utilisant filter puis map, la fonction doit renvoyer les noms des Jedis, c'est-à-dire les personnages du
côté lumineux (pour ceux qui auraient passé les 40 dernières années dans une caverne en Lozère !)
...
const getJedisNames = characters =>  characters.filter(person => person.side === "light").map(jediName => jediName.name)
